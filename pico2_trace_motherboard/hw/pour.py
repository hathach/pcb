...
_STITCH_VIAS_SPREAD = [
    ...
    # (78.0, 22.0) -> (75.0, 26.0): REV B moved J5 east 6.61mm so its
    # HOST_DM pad now lands at (77.975, 21.0), 1.0mm from the old spot
    # (DRC clearance + hole_clearance). The replacement sits west of J5's
    # body and 2.5mm south of the host track band (y<=23.5), stitching the
    # same pour region.
    (78.0, 6.0), (78.0, 14.0), (75.0, 26.0), (78.0, 30.0), (78.0, 38.0), (78.0, 54.0),
