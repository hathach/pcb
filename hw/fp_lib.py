...
FP = {
    ...
    # breakout_1x20 now point at custom SMD-socket footprints generated by
    # hw/gen_sockets.py (pad numbering "1".."N" unchanged from the stock
    # THT parts they replace -- the netlist/routing model keys off those
    # numbers). usb_a swaps the all-THT Molex 67643 for the GCT USB1046
    # (SMD signal pads, 2 THT mounting posts kept -- mechanically required).
    # hdr_1x02/hdr_1x03/hdr_1x06 swap to the stock "_SMD_Pin1Left" variants
    # (hdr_1x06 currently has no PARTS consumer -- J_TRACE_TP was removed
    # from the model in Task 14c -- kept here for forward consistency per
    # the Task 14d brief).
    "pico_socket": ("pico2_trace", "PicoSocket_2x20_SMD_ThruHole"),
    "breakout_1x20": ("pico2_trace", "PinSocket_1x20_SMD_ThruHole"),
